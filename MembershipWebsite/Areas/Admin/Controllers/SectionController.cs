...
namespace MembershipWebsite.Areas.Admin.Controllers
{
    public class SectionController : Controller
    {
        ...
        // GET: Admin/Section
        // retrieves and returns all sections to the view
        ...
        // retrieves and returns details of a section based on its Id
        ...
        // Bind() prevents anything but specified properties from being passed to the method
        // Prevents malicious code from entering the action
        ...
        // displays a section's data to the user based on its id
        ...
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        // used to send edited data to the database  
        [HttpPost]
        [ValidateAntiForgeryToken]
